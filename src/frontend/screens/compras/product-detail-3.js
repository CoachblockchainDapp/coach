                                    ...
                                    <div className="infor-product style-1">
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div data-wow-delay="0s" className="wow fadeInLeft author flex items-center">
                                                ...
                                                <div className="info">
                                                    <span>Owned by:</span>
                                                    <h6><Link to="/author01">Marvin McKinney</Link> </h6>
                                                </div>
                                            </div>
                                    ...
                                    <div data-wow-delay="0s" className="wow fadeInUp product-item time-sales">
                                        ...
                                        <div className="content">
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                <Link to="#" className="tf-button style-1 h50 w216">Place a bid<i className="icon-arrow-up-right2" /></Link>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="heading-section">
                                        ...
                                        <Link to="/explore-3" >Discover more <i className="icon-arrow-right2" /></Link>
                                    </div>
                                </div>
                                <div className="col-md-12">
                                    <FeaturedSlider1 />
