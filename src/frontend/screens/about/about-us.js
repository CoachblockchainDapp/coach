                            ...
                            <div className="row">
                                <div className="col-12 pages-title">
                                    <div className="content">
                                        <h1 data-wow-delay="0s" className="wow fadeInUp"><span style={{ color: 'black' }}>Experiencia única en la formación del mundo blockchain</span></h1>
                                        <p data-wow-delay="0.1s" className="wow fadeInUp"><span style={{ color: 'black' }}>Comienza con la plataforma más fácil y segura para comprar, intercambiar y aprender sobre arte digital y técnologia blockchain . Únete a nuestra comunidad educativa y explora el emocionante mundo de la tecnología blockchain y los NFTs.</span></p>

                                        <div data-wow-delay="0.2s" className="wow fadeInUp flat-button flex justify-center">
                                            <Link to="#" className="tf-button style-1 h50 w190">Empezar <i className="icon-arrow-up-right2" /></Link>
                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="heading-section-1">
                                        <h2 className="tf-title pb-40"><span style={{ color: 'black' }}>¿Por qué elegirnos?</span></h2>
                                    </div>
                                </div>
                                <div data-wow-delay="0s" className="wow fadeInUp col-md-4">
                                    <div className="box-icon-item">
                                        <img src="/assets/images/item-background/about-01.png" alt="" />
                                        <div className="title"><Link to="#">Pagos al Instante</Link></div>
                                ...
                                <div data-wow-delay="0.1s" className="wow fadeInUp col-md-4">
                                    <div className="box-icon-item">
                                        ...
                                        <div className="title"><Link to="#">Seguridad</Link></div>
                                ...
                                <div data-wow-delay="0.2s" className="wow fadeInUp col-md-4">
                                    <div className="box-icon-item">
                                        ...
                                        <div className="title"><Link to="#">Gestión con Contratos Inteligentes</Link></div>
                    ...
                    <div className="tf-section-2 wrap-accordion pt-80">
                        <div className="themesflat-container">
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="heading-section-1">
                                        <h2 className="tf-title pb-40"><span style={{ color: 'black' }}>Preguntas frecuentes</span></h2>
                                    </div>
                                </div>
                                ...
                                <div className="col-12">
                                    <div className="content">
                                        ...
                                        <p><span style={{ color: 'black' }}>¿No puedes encontrar lo que estás buscando? Por favor,</span> <Link to="/contact-us" className="tf-color">chatea con nuestro amable equipo</Link></p>
                                    </div>
                                </div>
                            </div>
                        </div>
