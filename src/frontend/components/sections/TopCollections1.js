    ...
    return (
        <>
            <div className="tf-section top-collections">
                <div className="CoachBlockchain-container">
                    <div className="row">
                        <div className="col-md-12">
                            <div className="heading-section pb-20">
                                <h2 className="tf-title ">Nuestras Colecciones</h2>
                                            ...
                                            <Link href="/author-2">
                                                <div className="media-images-collection">
                                                    ...
                                                    <div className="author-poster">
                                                        <img src="/assets/images/avatar/TERRA.png" alt="" className="w-full" />
                                                    </div>
                                                </div>
                                            </Link>
                                            <div className="card-bottom">
                                                <div className="author">
                                                    <h5><Link href="/author01">NFTs TERRA</Link></h5>
                                                    <div className="infor">@CoachBlockchain</div>
                                                </div>
